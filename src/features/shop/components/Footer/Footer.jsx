      ...
      <footer className="w-full bg-[#021736] pt-9 pb-4">
        ...
        <div className="flex items-center gap-2 ml-[110px] mt-8">
          <div className="w-[62px] h-[25px] bg-white rounded flex items-center justify-center">
            <img className="w-[50px] h-[20px]" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/PayPal.svg/2560px-PayPal.svg.png" alt="" />
          </div>
          <div className="w-[62px] h-[25px] bg-white rounded flex items-center justify-center">
            <img className="w-[50px] h-[20px]" src="https://marketing.uz/uploads/articles/1192/article-original.png" alt="" />
          </div>
          <div className="w-[62px] h-[25px] bg-white rounded flex items-center justify-center">
            <img className="w-[50px] h-[20px]" src="https://1000logos.net/wp-content/uploads/2021/11/VISA-logo.png" alt="" />
          </div>
          <div className="w-[62px] h-[25px] bg-white rounded flex items-center justify-center">
            <img className="w-[50px] h-[20px]" src="https://data.cbonds.info/organisations_logos/24325/1609314895logo-mastercard-mobile.png" alt="" />
          </div>
        </div>
      </footer>
